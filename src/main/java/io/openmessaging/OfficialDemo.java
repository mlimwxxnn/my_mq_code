 ...
 */
public class OfficialDemo extends MessageQueue {
    ...
    HashMap<String, Map<Integer, Long>> havenCheckedSet = new HashMap<>();
    ...
    public void clearAppendData(){
        appendData.clear();
    }

    public void setAllChecked(){
        havenCheckedSet.putAll(appendOffset);
        appendOffset.clear();
    }
